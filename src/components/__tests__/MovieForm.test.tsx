...
describe("MovieForm", () => {
  describe("Rendering", () => {
    ...
    it("should call onSubmit with correct data when form is submitted", async () => {
      ...
      expect(submittedData.imageUrl).toBe("https://example.com/new.jpg");
      expect(submittedData.durationInMinutes).toBe(90);
      expect(submittedData.rating).toBe(7.5);
      expect(submittedData.description).toBe("A new movie description");
      expect(submittedData.releaseDate).toEqual(new Date("2024-01-01"));
