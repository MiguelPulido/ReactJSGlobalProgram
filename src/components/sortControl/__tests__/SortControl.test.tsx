...
describe("SortControl Component", () => {
  ...
  it("should render sort control with label and select", () => {
    render(
      <SortControl
        currentSort={MovieSort.RELEASE_DATE}
  ...
  it("should display current sort selection correctly", () => {
    ...
    expect(selectElement.value).toBe(MovieSort.TITLE);
  });
  ...
  it("should have both sort options available", () => {
    ...
    expect(
      screen.getByRole("option", { name: MovieSort.RELEASE_DATE })
    ).toBeInTheDocument();
